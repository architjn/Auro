...
public class SearchView extends FrameLayout implements Filter.FilterListener {
    ...
    public void showSearch(View item, boolean animate) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mCardView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    SearchAnimator.revealInAnimation(mContext, menuItem, mCardView, startCy, SearchAnimator.ANIMATION_DURATION);
                }
            });
        }
    }
    ...
    public void setMenuItem(final MenuItem menuItem) {
        menuItem.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                showSearch(SearchView.this.menuItem, true);
                return true;
            }
        });
    }
